...
int gf3658_power_off(struct gf_dev *gf_dev)
{
	...
	/*pr_info("gf:%s shared power does not operate, exit\n", __func__);
	return rc;*/ // for PD1963 rest fail .
#ifdef USE_PLAT_POWER_SUPPLY
	if (gf_dev->vreg) {
