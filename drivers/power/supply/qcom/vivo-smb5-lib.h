...
#define AUDIO_DRP_VOTER			"AUDIO_DRP_VOTER"
#define OTG_DRP_VOTER			"OTG_DRP_VOTER"
...
#define CHECK_DRP_DISABLE_WORK_COUNT  15 /*15count*/
#define CHECK_DRP_DISABLE_WORK_PEROID_MS  (20000) /*20(s)*15(c) /60= 5min*/
...
struct smb_iio {
	...
	struct iio_channel	*bat_board_temp_chan;/*non-direct-charge used*/
	/*vivo end*/
};
...
struct smb_charger {
	...
	/* double check Vbus status */
	int vbus_check_count;
