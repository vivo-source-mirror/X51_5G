...
#define JEITA_EN_AFP_COLD	BIT(6)
...
/* vivo add */
#define SCHG_P_DCDC_VSYSMIN_CFG_REG		(DCDC_BASE + 0x83)
#define VSYSMIN_CFG_MASK					GENMASK(2, 0)
#define VSYSMIN_CFG_3P3V						6
/* vivo end */
...
/*vivo add start*/
#define USBIN_IN_COLLAPSE_GF_SEL_1MS	0
#define USBIN_IN_COLLAPSE_GF_SEL_5MS	1
#define USBIN_IN_COLLAPSE_GF_SEL_30MS	2
#define USBIN_IN_COLLAPSE_GF_SEL_30US	3
/*vivo add end*/
...
#define USBIN_AICL_START_AT_MAX_BIT		BIT(5) /* vivo add */
...
#define AICL_RERUN_TIME_3S_VAL			0x00 /* vivo add */
#define AICL_RERUN_TIME_12S_VAL			0x01
#define AICL_RERUN_TIME_45S_VAL			0x02 /* vivo add */
