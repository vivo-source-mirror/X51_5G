...
static const char * const boot_state[] = {
	[B_NONE] = "None",
	[B_BOOTLOADER] = "wdt_monitor(Bootlader|reboot,system_block)",
	[B_KERNEL] = "wdt_monitor(Kernel|reboot,system_block)",
	[B_FRAMEWORK] = "wdt_monitor(Framework|reboot,system_block)",
};
